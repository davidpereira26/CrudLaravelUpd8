              ...
              <div class="u-align-center u-container-style u-layout-cell u-size-30 u-white u-layout-cell-2">
                <div class="u-container-layout u-container-layout-2">
                  ...
                  <div class="u-form u-form-1">
                    <form action="{{route('create.store')}}" method="POST" style="padding: 10px;">
                      <div class="u-form-email u-form-group u-form-partition-factor-2">
                        <label for="email-bb9b" class="u-label">CPF</label>
                        @csrf
                        <input type="text" id="email-bb9b" name="cpf" class="u-grey-5 u-input u-input-rectangle u-radius-50" required="" placeholder="123.456.789-00">
                      </div>
                      <div class="u-form-group u-form-name u-form-partition-factor-2">
                        <label for="name-bb9b" class="u-label">Nome completo</label>
                        <input type="text" placeholder="Digite seu nome" id="name-bb9b" name="name" class="u-grey-5 u-input u-input-rectangle u-radius-50" required="">
                      </div>
                      <div class="u-form-date u-form-group u-form-group-3">
                        <label for="date-8ad3" class="u-label">Data nascimento</label>
                        <input type="date" placeholder="MM/DD/YYYY" id="date-8ad3" name="date" class="u-grey-5 u-input u-input-rectangle u-radius-50" required="">
                      </div>
                      ...
                      <div class="u-form-address u-form-group u-form-group-5">
                        ...
                        <input type="text" placeholder="Insira seu endereço" id="address-907e" name="address" class="u-grey-5 u-input u-input-rectangle u-radius-50" required="">
                      </div>
                      ...
                      <div class="u-form-group u-form-select u-form-group-7">
                        ...
                        <input type="submit" class="u-border-none u-btn u-btn-round u-btn-submit u-button-style u-palette-3-base u-radius-50 u-btn-1" value="Cadastrar">
                    </form>
                  </div>
                </div>
              </div>
